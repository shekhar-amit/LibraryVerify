...
`identicalAs(int id)` | `InputValidator.Builder` | The id of an TextField to which the field must be equal
...
A sample app with some use cases of the library is available on this [link](https://github.com/shekhar-amit/LibraryVerify/tree/master/entry)
